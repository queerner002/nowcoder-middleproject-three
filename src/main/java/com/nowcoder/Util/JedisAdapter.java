...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args) {
        ...
        jedis.del(listName);
        for (int i = 0; i < 10; ++i) {
            jedis.lpush(listName, "a" + String.valueOf(i));  //从左推进去
        }
        ...
        jedis.hsetnx(userKey, "school", "zju"); //hset if not exist
        ...
        print(22, jedis.sunion(likeKey1, likeKey2)); //求并 可以用来求共同好友，共同规范
        print(23, jedis.sdiff(likeKey1, likeKey2));//求互异
        print(24, jedis.sinter(likeKey1, likeKey2)); //求交集
        print(25, jedis.sismember(likeKey1, "12"));
        print(26, jedis.sismember(likeKey2, "12"));
        jedis.srem(likeKey1, "5");  //删掉5
        print(27, jedis.smembers(likeKey1));
        // 从1移动到2
        jedis.smove(likeKey2, likeKey1, "14");
        print(28, jedis.smembers(likeKey1));
        print(29, jedis.scard(likeKey1)); //likeKey1中有多少个值

        // 排序集合，优先队列，排行榜  zsort sorted set
